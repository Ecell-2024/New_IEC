...
export default function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className="flex items-center gap-x-2 p-1 font-medium hover:font-bold"
      >
        {/* Icon */}
  ...
  return (
    <Navbar className="top-0 sticky px-4 py-2 lg:py-4 text-black z-20 bg-[#fff]">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900 ">
        ...
        >
          <img
            ...
            alt="Logo"
            className="h-10 mix-blend-hard-light w-15"
          />
          <span className="mx-2 my-2">IEC KIET</span>
        </Typography>
